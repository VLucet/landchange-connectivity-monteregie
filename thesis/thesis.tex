...
\SetAcknowledgeText{
For providing vital guidance and parts of the code, I thank Dr. Bronwyn Rayfield. For providing help with computing resources parts of the code, I thank Dr. Guillaume Larocque. For providing advice on STSIM implementation and code, I thank Dr. Colin Daniel and Dr. Leonardo Frid. I thank Dr. Guillaume Larocque and Dr. Yann Boulanger for their help in providing the LANDIS outputs and editorial help for the associated appendix. \\
\indent I thank all students, staff and organizations involved in the design and realisation of the workshop. I thank Aurélie Sierra for her invaluable guidance and counsel. I thank all students and staff facilitators: Madeleine Gauthier, Mikayla Salmon-Beitel and Violette Bertrand. I thank Geneviève Poirier and Mariève Lafontaine for their participation in the design, planning and organization of the workshop. I also thank Renée Gagnon for her precious help securing a location for the workshop.
\indent For providing essential funding for this project, I thank the Fonds de recherche du Québec – Nature et technologies (FRQNT). For providing logistical support I thank Dr. Helen Elina and Mr. Philippe Auzel. \\
\indent For providing key information on land use data, I thank Martin Joly, Marie-Josée Côté and Benoit Jobin. \\
\indent I thank my supervisor, Prof. Andrew Gonzalez, for his support and for believing in my abilities every step of the way. I also thank members of my committee, Prof. Brian Leung and Prof. Elena Bennett for their timely and wise council at every committee meeting. I thank all my fellow grad students and especially Alex Arkilanian for all the help revising proposals, discussion ideas, and providing key support. \\
\indent I thank my mother Laura, my father Philippe, and Talia for their unwavering support. Thank you to Blanka and Peter for sheltering me and putting up with my writing process during the thick of the pandemic. \\
}%
\Acknowledge%
...
\\
\\
\textbf{Chapter 1:} Lucet, V. Gonzalez, A. (2020), Integrating Land Use Change Modelling with Connectivity Modelling. %\textit{Journal of Ecographic Informatics} 10 (1), 878887.
\\
\\
\textbf{Chapter 2:} Lucet, V. Gonzalez, A. (2020), Integrating Stakeholders Perceptions of Connectivity Conservation Priorities into a Spatially Explicit Land Use and Connectivity Change Model. %\textit{Journal of Ecographic Informatics} 10 (1), 878887.
\\
\\
}
\Link%
...
% Discussion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\SetDiscName{General Discussion \& Conclusion}%

\SetDiscText{

The two chapters of this thesis each provide parts of a strategy for addressing the two limitations to Connectivity Conservation Planning methods identified in the general introduction: the lack of methodological integration between connectivity, land use change and climate change models ; and the need for stakeholder inputs in the planning process. \\

In chapter 1, we integrated circuit-theory based connectivity models with a simple land use and climate change model based on habitat suitability for 5 umbrella species. We also showed patterns of land use change in our study region for the 1990-2010 period, and demonstrated that our land use change model is a generalization of these patterns across the landscape. We analysed changes in connectivity under simple land use and climate change scenarios, and showed that different species have different responses, depending on the forest type they depend on, and on whether this forest type is under threat by land use change, climate change or both. The american marten showed the most complex response because it is dependent on coniferous forest type which is the most at risk under both drivers. We also used a pattern-detection method (SURF) to identify pinch-points and salient connectivity flow features. Although the number of features detected is species-specific, we showed a mostly consistent pattern of change over time: reforestation seems to simplify the flow. More research to understand the links between flow complexity and SURF measures is needed. \\

Then, in chapter 2, we capitalized on chapter 1’s progress by including the results of a stakeholder workshop during which we mapped consensual areas of importance for connectivity in the region. During this participatory process, we also identified key assets (such as the drive and momentum of conservation NGOs in the region) and obstacles (such as the predominance of agricultural matrix) to connectivity conservation in the region. We derived simple conservation scenarios based on priorities identified during the participatory mapping exercise. We simulated connectivity changes for our 5 species under these scenarios and put in evidence the complexity of restoring connectivity to cater to species with different needs while accounting for multiple stakeholder interests. \\
