...
%TODO mention bronwyn for parts of the code, Guillaume and Bronwyn for parts of the code and for providing LANDIS summary for out model inputs. + Yann and NRCAN.
...
\newcommand*{\ETDDiscName}{DiscMENTS}%
