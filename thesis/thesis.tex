...
\\
\\
\textbf{Chapter 1:} Lucet, V. Gonzalez, A. (2020), Integrating Land Use Change Modelling with Connectivity Modelling, a Case Study in Montérégie, Southern Québec. %\textit{Journal of Ecographic Informatics} 10 (1), 878887.
\\
\\
...
Next, we introduce the two other key conceptual themes of the thesis: land use change modelling and participatory methods. \\ \vspace{1em}
