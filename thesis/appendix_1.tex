...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/scenario_39_compare.png}
}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/scenario_42_compare.png}
}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/scenario_45_compare.png}
}
 \caption{Corr).}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/scenario_48_compare.png}
}
 \caption{CorrRef).}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/scenario_51_compare.png}
}
 \caption{CorrRefTar.}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/radar_ggradar_both.png}
}
