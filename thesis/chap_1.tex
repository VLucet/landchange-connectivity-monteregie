...
\begin{table}[h!]
\centering
\caption{Variable importance (gini impurity index) for both random forest models - non-categorical variables only (rounded to nearest integer).}
\label{tab:varimp}
\begin{tabular}{lcc}
\hline
\hline
...
Distance from urban land & 2118 & 571 \\
Size of forest patch & 409 & 8424 \\
Elevation & 184 & 796 \\
