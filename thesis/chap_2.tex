...
\begin{figure}[h!]
\makebox[\textwidth]{
\includegraphics[width=\textwidth]{thesis/figures/bar_chap2.png}
}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/connectivity_decrease_x5species_chap2.png}
}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/radar_ggradar_chap2.png}
}
 \caption{Change in mean flow (in \% of the the 2010 flow) between 2010 and 2100, contrasting BAU scenario (solid line) with conservation scenarios.}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/hist_chap2.png}
}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/surf_chap2.png}
}
...
\begin{figure}[h!]
\makebox[\textwidth]{
  \includegraphics[width=\textwidth]{thesis/figures/surf_radar_chap2.png}
}
 \caption{Change in identified features (partly pinch-points.}
