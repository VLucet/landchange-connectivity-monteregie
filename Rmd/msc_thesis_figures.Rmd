...
hist_plot_1 <- histograms %>% 
  ...
  NULL
hist_plot_1
ggsave("outputs/figures/hist_chap1.png", hist_plot_1, width = 15, height = 15)
```
...
hist_plot_2 <- histograms %>% 
  ...
  NULL
hist_plot_2
ggsave("outputs/figures/hist_chap2.png", hist_plot_2, width = 15, height = 20)
```
...
surf_1 <- surf %>% 
  ...
  NULL
surf_1
ggsave("outputs/figures/surf_chap1.png", surf_1, width = 15, height = 15)
```
...
surf_radar_1 <- 
  ggradar(surf_radar_data_1, centre.y = -60, legend.position = "right",
          ...
          axis.label.size=5)
surf_radar_1
ggsave("outputs/figures/surf_radar_chap1.png", surf_radar_1, width = 15, height = 10)
```
...
surf_2 <- surf %>% 
  ...
  NULL
surf_2
ggsave("outputs/figures/surf_chap2.png", surf_2, width = 15, height = 15)
```
...
surf_radar_2 <- 
  ggradar(surf_radar_data_2, centre.y = -60, legend.position = "right",
          ...
          axis.label.size=5)
surf_radar_2
ggsave("outputs/figures/surf_radar_chap2.png", surf_radar_2, width = 15, height = 10)
```
