...
radar_chap1 <-  
  ggradar(radar_data_chap1, centre.y = -20, legend.position = "right",
          ...
          axis.label.size=5)
radar_chap1
ggsave("../thesis/figures/radar_ggradar_chap1.png", radar_chap1, width = 15, height = 10)
```
...
radar_chap2 <-  
  ggradar(radar_data_chap2, centre.y = -20, legend.position = "right",
          ...
          axis.label.size=5)
radar_chap2
ggsave("../thesis/figures/radar_ggradar_chap2.png", radar_chap2, width = 15, height = 10)
```
...
radar_all <-  
  ggradar(radar_data_all, centre.y = -20, legend.position = "right",
          ...
          axis.label.size=5)
radar_all
ggsave("../thesis/figures/radar_ggradar_both.png", radar_all, width = 15, height = 10)
```
...
hist_plot_1 <- histograms %>% 
  ...
  NULL
hist_plot_1
ggsave("../thesis/figures/hist_chap1.png", hist_plot_1, width = 15, height = 15)
```
...
hist_plot_2 <- histograms %>% 
  ...
  NULL
hist_plot_2
ggsave("../thesis/figures/hist_chap2.png", hist_plot_2, width = 15, height = 20)
```
...
surf_1 <- surf %>% 
  ...
  NULL
surf_1
ggsave("../thesis/figures/surf_chap1.png", surf_1, width = 15, height = 15)
```
...
surf_radar_1 <- 
  ggradar(surf_radar_data_1, centre.y = -60, legend.position = "right",
          ...
          axis.label.size=5)
surf_radar_1
ggsave("../thesis/figures/surf_radar_chap1.png", surf_radar_1, width = 15, height = 10)
```
...
surf_2 <- surf %>% 
  ...
  NULL
surf_2
ggsave("../thesis/figures/surf_chap2.png", surf_2, width = 15, height = 15)
```
...
surf_radar_2 <- 
  ggradar(surf_radar_data_2, centre.y = -60, legend.position = "right",
          ...
          axis.label.size=5)
surf_radar_2
ggsave("../thesis/figures/surf_radar_chap2.png", surf_radar_2, width = 15, height = 10)
```
...
hist_plot_origin <- histograms %>%
  ...
  NULL
hist_plot_origin
ggsave("../thesis/figures/original_hists.png", hist_plot_origin, width = 15, height = 10)
```
...
```{r BAU, eval=FALSE, include=FALSE, message=FALSE, warning=FALSE}
# draw_scenario(39)
final_df_39 <- draw_scenario(39, return_df = T)
...
```{r reforestation, eval=FALSE, include=FALSE, message=FALSE, warning=FALSE}
# draw_scenario(42)
final_df_42 <- draw_scenario(42, return_df = T)
...
```{r bar_boths, eval=FALSE, include=FALSE}
...
assembled
ggsave("../thesis/figures/bar_both.png", assembled, width = 15, height = 20)
```

```{r eval=FALSE, include=FALSE, message=FALSE, warning=FALSE}
# draw_scenario(42) ...

all_chap2 <- draw_scenario(42, return_df = T) %>% 
  bind_rows(draw_scenario(45, return_df = T)) %>% 
  bind_rows(draw_scenario(48, return_df = T)) %>% 
  bind_rows(draw_scenario(51, return_df = T))
...
bar_chap2 <- all_chap2 %>% 
  ...
  NULL
bar_chap2
ggsave("../thesis/figures/bar_chap2.png", bar_chap2, width = 15, height = 20)
```