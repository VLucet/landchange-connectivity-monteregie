...
```{r roc_curves, eval=big_figures, message=FALSE, warning=FALSE, warning=FALSE}
# Roc curves data
...
```{r original_hists, message=FALSE, warning=FALSE, warning=FALSE}
...
```{r hist_plot_1, message=FALSE, warning=FALSE, warning=FALSE}
...
```{r hist_plot_2, message=FALSE, warning=FALSE, warning=FALSE}
