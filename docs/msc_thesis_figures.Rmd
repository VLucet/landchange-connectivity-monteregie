...
**This regroups most of the figures in the thesis (appendix figures are not included, except for the ROC resample figures and BAU simulated land use change).**
...
ROC curves from fitting both models, plotted with the `patchwork` package.
