...
final <- raster("../data/land_use/aggregated/aggregated_lu_buffered_2010_patched.tif") == class
  ...
  ggsave(plot = final_plot, filename = paste0("../thesis/figures/",names[class]), width = the_width, height = the_height, dpi = the_dpi)
}
```
...
the_folder <- "../test/july/all/monteregie-conncons-scripted.ssim.output"
# draw_scenario(39)
final_df_39 <- draw_scenario(sce = 39, return_df = T, sce_folder=the_folder)
