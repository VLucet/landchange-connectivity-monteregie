...
df_final <- read_csv("../outputs/final/final_df_current_density.csv") %>%
  mutate(timestep = (timestep*10)+1990, source = "model", zone = as.factor(zone))
...
```{r roc_curves, eval=params$big_figures, message=FALSE, warning=FALSE, out.width="100%"}
# Roc curves data
...
```{r 2010_compare_prep, eval=params$big_figures, message=FALSE, warning=FALSE, out.width="100%"}
...
```{r 2010_compare_urb, eval=params$big_figures, message=FALSE, warning=FALSE, out.width="100%"}
...
```{r compare, eval=params$big_figures, message=FALSE, warning=FALSE, out.width="100%"}
