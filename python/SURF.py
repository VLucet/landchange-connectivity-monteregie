...
def surf(img, h_threshold=1000, oct_layers=3, oct_nb=4, upright=False, verbose=False, kp_only=True):
    import cv2
    ...
    surf_engine = cv2.xfeatures2d_SURF.create()
...
def process_flow(img, in_range=(2, 20), out_range=(0, 255), h_threshold=20000,
    ...
    img_annotated = surf(img_processed, h_threshold, oct_layers, oct_nb, upright, verbose, kp_only)
